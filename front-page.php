...
<main class="home">
    ...
    <a class="banner-link" href="https://docs.google.com/forms/d/e/1FAIpQLSctw2SH7VHnIps4jjwcAPWTOacI4yIKH1L6tYdWY_OFykvG2Q/viewform?usp=send_form" target="_blank" rel="noopener noreferrer">
                ...
                <li class="teachers_item is-reverse fade-in">
                    ...
                    <div class="teachers_item_body">
                        ...
                        <p class="teachers_item_text">
                            ...
                            院長依存型の医院からチーム成長型医院への転換支援を行う。<br>
                            教育とは知識ではなく目標達成のためのツール。<br>
                            人が育ち、組織が成長し、結果として医療の質が向上する。<br>
                            その循環を設計することを自身の専門領域としている。<br>
                            教育・評価・組織設計を通じ「スタッフが医院経営に関われる世界」の実現を目指している。<br>
                ...
                <li class="teachers_item is-reverse fade-in">
                    ...
                    <div class="teachers_item_body">
                        ...
                        <p class="teachers_item_text">
                            ...
                            息育指導士<br>
                            臨床歯科麻酔認定歯科衛生士<br>
                            日本臨床CADCAM学会　役員<br><br>

                            【経歴】<br>
                            2015年〜2019年 保険治療（保険点数30万点/月）・完全自費治療 経験<br>
                            2019年 IPOをサポートする企業にて勤務<br>
                            2022年 BRISTO DENTAL CLINIC 副院長就任<br>
                        </p>
                    </div>
                </li>
            </ul>
